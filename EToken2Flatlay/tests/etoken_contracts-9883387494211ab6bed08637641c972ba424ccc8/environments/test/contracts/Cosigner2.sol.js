...
(function() {
  ...
  var contract_data = {
    ...
    address: "0x6a2a4787584444e3f14252dec99429658bf04a0c",
    generated_with: "2.0.9",
    contract_name: "Cosigner2"
  };

  function Contract() {
    if (Contract.Pudding == null) {
      throw new Error("Cosigner2 error: Please call load() first before creating new instance of this contract.");
    }
  ...
  Contract.new = function() {
    if (Contract.Pudding == null) {
      throw new Error("Cosigner2 error: Please call load() first before calling new().");
    }
  ...
  Contract.at = function() {
    if (Contract.Pudding == null) {
      throw new Error("Cosigner2 error: Please call load() first before calling at().");
    }
  ...
  Contract.deployed = function() {
    if (Contract.Pudding == null) {
      throw new Error("Cosigner2 error: Please call load() first before calling deployed().");
    }
