...
(function() {
  ...
  var contract_data = {
    ...
    address: "0x5453f113c173a4b7a93f3911fa2573e242784f1b",
    generated_with: "2.0.9",
    contract_name: "Cosigner1"
  };

  function Contract() {
    if (Contract.Pudding == null) {
      throw new Error("Cosigner1 error: Please call load() first before creating new instance of this contract.");
    }
  ...
  Contract.new = function() {
    if (Contract.Pudding == null) {
      throw new Error("Cosigner1 error: Please call load() first before calling new().");
    }
  ...
  Contract.at = function() {
    if (Contract.Pudding == null) {
      throw new Error("Cosigner1 error: Please call load() first before calling at().");
    }
  ...
  Contract.deployed = function() {
    if (Contract.Pudding == null) {
      throw new Error("Cosigner1 error: Please call load() first before calling deployed().");
    }
